...
namespace HerbstSchulung.EntityFramework.Migrations
{
    ...
    [Migration("20251019070142_AddNodes")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HerbstSchulung.EntityFramework.DataModel.Node", b =>
                {
                    b.Property<string>("Id")
                        .HasMaxLength(64)
                        .HasColumnType("nvarchar(64)");
            ...
            modelBuilder.Entity("HerbstSchulung.EntityFramework.DataModel.Node", b =>
                {
                    b.HasOne("HerbstSchulung.EntityFramework.DataModel.Node", "Parent")
                        .WithMany("Children")
            ...
            modelBuilder.Entity("HerbstSchulung.EntityFramework.DataModel.Angebot", b =>
                {
                    b.OwnsOne("HerbstSchulung.EntityFramework.DataModel.Geld", "BetragBrutto", b1 =>
                        {
                            b1.Property<string>("AngebotId")
                                .HasColumnType("nvarchar(64)");

                            b1.Property<string>("Waehrung")
                                .IsRequired()
                                .HasMaxLength(3)
                                .HasColumnType("nvarchar(3)")
                                .HasColumnName("BetragBrutto_Waehrung");

                            b1.Property<decimal>("Wert")
                                .HasColumnType("decimal(18,2)")
                                .HasColumnName("BetragBrutto_Wert");
                    ...
                    b.OwnsOne("HerbstSchulung.EntityFramework.DataModel.Geld", "BetragBrutto", b1 =>
                        {
                            ...
                            b1.HasKey("RechnungId");

                            b1.ToTable("Rechnungen");
